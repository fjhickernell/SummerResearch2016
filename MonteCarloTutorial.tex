...
\end{Bmatrix},
\end{multline*}
is too difficult to evaluate analytically because $\omega$ is too complex.  Here $\Omega \subseteq \reals$ is the \beamerbutton{\href{http://en.wikipedia.org/wiki/Sample_space}{sample space}}  of $Y$---the set of all possible values for $Y$.  
